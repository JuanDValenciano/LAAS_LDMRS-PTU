...
import actionlib, actionlib_tutorials.msg
...
class ptu_light(object):
    ...
    def PTU_profile(self):
        ...
        # Tilt
        goal.axis.value = 1
        goal.base_speed = 1000
        goal.acceleration = 2000
        goal.speed = 1000
        goal.unit.value = 2
        client.send_goal(goal)
...
class sickLDMRS(object):
    ...
    def callbackData(self, data):
        ...
        #print dir(data)
        #print("\n Here we are again 2: \t")
        #print (data.points[N-1].horizontal_angle)
    ...
    def LDMRS_getData(self, Tilt, Pan):
        ...
        while(lastscane==[]):
            lastscane=self.lastScan
        n=lastscane.scan_points-1
        #print "\n\t layerGet: "+str(n)#+str(lastscane.points[n].layer)
        return lastscane
